...
:FOREST => {
	:name => "Forest Field",
	:fieldMessage => [
		"Trees surround the arena!"
	],
	:graphic => ["forestgreenwood", "forestgreenwood_day", "forestgreenwood_night"],
	:secretPower => "WOODHAMMER",
	:naturePower => :WOODHAMMER,
	:mimicry => :BUG,
	# Abilities activated on Forest Fire Field
	:abilityActivate => {
	...
	:moveStatStageMods => {
		...
		:ASSEMBLYORDER => { stats_override: { :ATTACK => 2, :SPECIAL_ATTACK => 2 }, message: "The forest powered up the offense!" },
	},
	:damageMods => {
		0.5 => [:SURF, :MUDDYWATER, :ROCKTHROW],
		1.5 => [:GRAVAPPLE, :ATTACKORDER, :SLASH, :AIRSLASH, :FURYCUTTER, :AIRCUTTER, :PSYCHOCUT, :BREAKINGSWIPE],
		2.0 => [:HURRICANE],
	},
	:accuracyMods => {},
	:moveMessages => {
		"The forest softened the attack..." => [:SURF, :MUDDYWATER],
		"The rocks hit the trees instead..." => [:ROCKTHROW],
		...
		"The hurricane devastated the forest!" => [:HURRICANE],
	},
	:typeMods => {
	...
	:moveEffects => {
		"@battle.field_counters.counter += 1" => [:SURF],
		"@battle.field_counters.counter += 2" => [:MUDDYWATER],
		"@battle.field_counters.counter2 += 1" => [:BLIZZARD, :SLEETCANNON],
	},
	:typeBoosts => {
		1.5 => [:BUG, :GRASS],
	},
	...
	:changeCondition => {
		:SWAMP => "@battle.field_counters.counter > 2",
		:SNOWFOREST => "@battle.field_counters.counter2 > 2",
	},
	:fieldChange => {
		:SWAMP => [:SURF, :MUDDYWATER],
		:FORESTFIRE => [:FIREPLEDGE, :FIREBLAST, :FLAMEBURST, :ERUPTION, :SEARINGSHOT, :BLASTBURN, :LAVAPLUME, :MINDBLOWN, :BURNUP, :BURNINGJEALOUSY, :INCINERATE],
		:SNOWFOREST => [:SLEETCANNON, :BLIZZARD],
		:PETRIFIEDFOREST => [:OBLIVIONWING, :ROAROFTIME, :GLARE, :PETRIFY],
		:DARKFOREST => [:DARKVOID, :NIGHTDAZE, :DARKPULSE],
		:LIGHTFOREST => [:GEOMANCY, :FLASH, :SPRINGTIDESTORM],
		#:DECIDUOUSFOREST => [:LEAFSTORM, :RAZORLEAF, :LEAFBLADE],
	},
	:dontChangeBackup => [],
	:changeMessage => {
		"The forest became marshy!" => [:SURF, :MUDDYWATER],
		"The forest was set ablaze!" => [:FIREPLEDGE, :FIREBLAST, :FLAMEBURST, :ERUPTION, :SEARINGSHOT, :BLASTBURN, :LAVAPLUME, :MINDBLOWN, :BURNUP, :BURNINGJEALOUSY, :INCINERATE],
		"The forest was covered in snow!" => [:SLEETCANNON, :BLIZZARD],
		"The forest was petrified!" => [:OBLIVIONWING, :ROAROFTIME, :GLARE, :PETRIFY],
		"The forest was shrouded in darkness!" => [:DARKVOID, :NIGHTDAZE, :DARKPULSE],
		"The forest was bathed in light!" => [:GEOMANCY, :FLASH, :SPRINGTIDESTORM],
	},
	:statusMods => [:ASSEMBLYORDER, :DEFENDORDER, :GROWTH, :STRENGTHSAP, :HEALORDER, :NATURESMADNESS, :FORESTSCURSE, :INGRAIN],
	:changeEffects => {},
	:seed => {
		:seedtype => :TELLURICSEED,
		:effect => :Protect,
...
:FORESTFIRE => {
	...
	# Abilities activated on Forest Fire Field
	:abilityActivate => {
		:BLAZE      => {},  # Always active (hardcoded in section 100)
		:FLASHFIRE   => { eor: true, grounded: true },  # EOR: activates Flash Fire boost if grounded  # Always active (hardcoded in section 100)
		:FLAREBOOST => {},  # Defense boost (hardcoded in section 100)
	},
	# Ability mods
	:abilityMods => {
		:LONGREACH => { accuracy: 0.9 },  # Accuracy drops
	...
	:damageMods => {
		1.5 => [:HOGSBANEWHEEL, :WOODHAMMER],
		2.0 => [:HURRICANE],
	},
	:accuracyMods => {},
	:moveMessages => {
		"The hogsbane plants caught fire!" => [:HOGSBANEWHEEL],
		"The wood was on fire!" => [:WOODHAMMER],
		"The hurricane devastated the forest!" => [:HURRICANE],
	},
	:typeMods => {
		:FIRE => [:WOODHAMMER],
	...
	:typeMessages => {
		"The dying swarm takes its last stand!" => [:BUG],
		"The burning forest strengthened the attack!" => [:GRASS],
		"The forest fire amplified the attack!" => [:FIRE],
	},
	:typeCondition => {},
	:typeEffects => {},
	:changeCondition => {
	...
	:fieldChange => {
		:FOREST => [:SURF, :MUDDYWATER, :WATERSPOUT, :WATERPLEDGE, :ORIGINPULSE, :WATERSPORT, :RAINDANCE, :DAMPENEDTERRAIN, :HURRICANER],
	},
	:dontChangeBackup => [],
	:changeMessage => {
		"The forest fire was put out!" => [:SURF, :MUDDYWATER, :WATERSPOUT, :WATERPLEDGE, :ORIGINPULSE, :WATERSPORT, :RAINDANCE, :DAMPENEDTERRAIN, :HURRICANER],
	},
	:statusMods => [:LEECHSEED, :FORESTSCURSE, :INGRAIN],
	:changeEffects => {},
	:seed => {
		:seedtype => :TELLURICSEED,
		:effect => [:Protect, :MultiTurnAttack],
		:duration => :SpikyShield,
		:message => "The Telluric Seed shielded {1} against damage while capturing {1} in the fire!",
		:animation => [:SPIKYSHIELD,:FIRESPIN],
		:stats => {},
	},
},
:DARKFOREST => { # Section 101
	:name => "Dark Forest Field",
	:fieldMessage => [
		"Monsters hide in the darkness."
	],
	:graphic => ["forestgloomaledark", "forestgloomaledark_day", "forestgloomaledark_night"],
	:secretPower => "DARKVOID",
	:naturePower => :DARKVOID,
	:mimicry => :DARK,
	# Abilities activated on Dark Forest Field
	:abilityActivate => {
		:SHADOWSHIELD   => {always_active: true},  # Always active (hardcoded in section 101)
		:PRISMARMOR     => {},  # Never active (hardcoded in section 101)
		:CURSEDBODY     => {},  # Doubled Activation chance (hardcoded in section 101)
		:MULTITYPE     => {},  # Will always become Dark type regardless of item (hardcoded in section 101)
		:RKSSYSTEM     => {},  # Will always become Dark type regardless of item (hardcoded in section 101)
		:MAGICGUARD     => {},  # Fails unless Dark-Type (hardcoded in section 101)
		:MAGICBOUNCE     => {},  # Fails unless Dark-Type (hardcoded in section 101)
		:JUSTIFIED     => { attack_boost_entry: true},  # Boost Attack by +1 on entry (hardcoded in section 101)
	},
	# Move stat stage modifiers
	:moveStatStageMods => {
		:MEMENTO => { stats_override: { :ATTACK => -4, :SPECIAL_ATTACK => -4 }, message: "The darkness wippity wippity!" },
		:PARTINGSHOT => { stats_override: { :ATTACK => -2, :SPECIAL_ATTACK => -2 }, message: "The darkness did something wip!"},
		:NASTYPLOT   => { stages: 3, message: "Evil will prosper..." },
		:FLEURCANNON => { stats_override: { :SPECIAL_ATTACK => -3 }, message: "The light of the forest protected you!"},
		:GEOMANCY => { stats_override: { :ATTACK => 1, :SPECIAL_ATTACK => 1, :SPEED => 1 }, message: "The darkness put out the light..."},
		:SYNTHESIS => { heal_percent: 0.75, message: "{1} absorbed any energy from the forest!" },
		:WISH => { heal_percent: 0.75, message: "{1}'s wish was powered by the darkness!" },
	...
	:accuracyMods => {
		85 => [:DARKVOID],  # Focus Blast accuracy increased to 90%
	},
	:moveMessages => {
		"The monsters in the darkness go on the pursuit!" => [:PURSUIT],
	},
	:typeMods => {},
	:typeAddOns => {},
	:moveEffects => {
		"@battle.field_counters.counter += 1" => [:FLASH],
		"@battle.field_counters.counter += 2" => [:DAZZLINGGLEAM, :FLASHCANNON],
		"@battle.field_counters.counter += 4" => [:LIGHTOFRUIN, :PRISMATICLASER, :LIGHTTHATBURNSTHESKY, :LUSTERPURGE, :PHOTONGEYSER],
	},
	:typeBoosts => {
		0.5 => [:PSYCHIC],
		1.2 => [:FAIRY],
	...
	:typeMessages => {
		...
		"The fairys fought through the darkness!" => [:FAIRY],
		"The forestry strengthened the attack!" => [:GRASS],
		"The obscurity of the forest boosted the attack!" => [:DARK],
	},
	:typeCondition => {},
	:typeEffects => {},
	:changeCondition => {
		:LIGHTFOREST => "@battle.field_counters.counter > 3",
	},
	:fieldChange => {
		:LIGHTFOREST => [:FLASH, :DAZZLINGGLEAM, :FLASHCANNON, :LIGHTOFRUIN, :PRISMATICLASER, :LIGHTTHATBURNSTHESKY, :LUSTERPURGE, :PHOTONGEYSER],
	},
	:dontChangeBackup => [],
	:changeMessage => {
		"The forests light shined through!" => [:FLASH, :DAZZLINGGLEAM, :FLASHCANNON, :LIGHTOFRUIN, :PRISMATICLASER, :LIGHTTHATBURNSTHESKY, :LUSTERPURGE, :PHOTONGEYSER],
	},
	:statusMods => [:FLEURCANNON, :NASTYPLOT, :PARTINGSHOT, :DARKVOID, :NASTYPLOT, :GEOMANCY, :NATUREPOWER, :FORESTSCURSE, :WISH, :MOONLIGHT, :SYNTHESIS],
	:changeEffects => {},
	:seed => {
		:seedtype => :TELLURICSEED,
		:effect => :Wish,
...
:LIGHTFOREST => { # Section 102
	:name => "Light Forest Field",
	:fieldMessage => [
		"The forest is shimmering with light!"
	],
	:graphic => ["forestgloomalelight"],
	:secretPower => "FAIRYWIND",
	:naturePower => :FLORALHEALING,
	:mimicry => :FAIRY,
	# Abilities activated on Light Forest Field
	:abilityActivate => {
		:SHADOWSHIELD   => {always_active: false},  # Never active (hardcoded in section 102)
		:PRISMARMOR     => {always_active: true},  # Always active (hardcoded in section 102)
		:CURSEDBODY     => {},  # Doubled Activation chance (hardcoded in section 102)
		:MULTITYPE     => {},  # Will always become Fairy type regardless of item (hardcoded in section 102)
		:RKSSYSTEM     => {},  # Will always become Fairy type regardless of item (hardcoded in section 102)
		:JUSTIFIED     => { attack_boost_entry: true},  # Boost Attack by +3 on entry (hardcoded in section 102)
	},
	# Move stat stage modifiers
	:moveStatStageMods => {
		:MEMENTO => { stats_override: { :ATTACK => -4, :SPECIAL_ATTACK => -4 }, message: "The darkness wippity wippity!" },
		:PARTINGSHOT => { stats_override: { :ATTACK => -2, :SPECIAL_ATTACK => -2 }, message: "The darkness did something wip!"},
		:NASTYPLOT   => { stages: 1, message: "Evil shall not last..." },
		:FLEURCANNON => { stats_override: { :SPECIAL_ATTACK => -1 }, message: "The light of the forest protected you!"},
		:SYNTHESIS => { heal_percent: 0.75, message: "{1} absorbed any energy from the forest!" },
		:WISH => { heal_percent: 0.75, message: "{1}'s wish was powered by the darkness!" },
		:MOONLIGHT => { heal_percent: 0.75, message: "The moonlight was strengthened by darkness!" },
	},
	...
	:accuracyMods => {
		30 => [:DARKVOID],  # Dark Void accuracy lowered to 30%
	},
	:moveMessages => {
		"The monsters are too scared to pursuit..." => [:PURSUIT],
	},
	:typeMods => {},
	:typeAddOns => {},
	:moveEffects => {
		"@battle.field_counters.counter += 2" => [:NIGHTDAZE, :DARKPULSE, :UNRELENTINGMALICE, :HEARTBREAK],
		"@battle.field_counters.counter += 4" => [:DARKVOID, :RUINATION, :NIHILLIGHT],
	},
	:typeBoosts => {
		1.1 => [:PSYCHIC],
		1.2 => [:DARK],
	...
	:typeMessages => {
		"The light powered the attack!" => [:PSYCHIC],
		"Darnkess fought through the light!" => [:DARK],
		"The forestry strengthened the attack!" => [:GRASS],
		"The luminescence of the forest boosted the attack!" => [:FAIRY],
	},
	:typeCondition => {},
	:typeEffects => {},
	:changeCondition => {
		:DARKFOREST => "@battle.field_counters.counter > 3",
	},
	:fieldChange => {
		:DARKFOREST => [:NIGHTDAZE, :DARKPULSE, :UNRELENTINGMALICE, :HEARTBREAK, :DARKVOID, :RUINATION, :NIHILLIGHT],
	},
	:dontChangeBackup => [],
	:changeMessage => {
		"Darkness filled the forest!" => [:NIGHTDAZE, :DARKPULSE, :UNRELENTINGMALICE, :HEARTBREAK, :DARKVOID, :RUINATION, :NIHILLIGHT],
	},
	:statusMods => [:FLEURCANNON, :NASTYPLOT, :DARKVOID, :GEOMANCY, :NATUREPOWER, :FORESTSCURSE, :WISH, :MOONLIGHT, :SYNTHESIS, :FLORALHEALING],
	:changeEffects => {},
	:seed => {
		:seedtype => :MAGICALSEED,
		:effect => :CraftyShield,
		:duration => 1,
		:message => "A crafty shield appeared around {1}!",
		:animation => :CRAFTYSHIELD,
		:stats => {
			:SPECIAL_ATTACK => 1,
		},
	},
